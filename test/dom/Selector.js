...
describe("Selector", function() {
  ...
  it("unwanted parent", function() {
    ...
    var multiSelector = new Selector({
      attribute: "class",
      value: "child",
      multiple: true
    })

    var singleSelector = new Selector({
      attribute: "class",
      value: "child"
    })
    var unwantedParentSelector = new Selector({
      attribute: "class",
      value: "parent"
    })
